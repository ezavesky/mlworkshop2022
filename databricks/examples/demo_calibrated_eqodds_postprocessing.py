...
# MAGIC %md
# MAGIC #### This notebook demonstrates the use of an odds-equalizing post-processing algorithm for bias mitigiation.
...
# MAGIC                 import load_preproc_data_adult, load_preproc_data_compas
# MAGIC 
# MAGIC from sklearn.preprocessing import scale
...
# MAGIC %md
# MAGIC ### Fairness metrics for original dataset
...
# MAGIC %md
# MAGIC #### Divide dataset into train, validation, and test partitions (70-30)
...
# MAGIC %md
# MAGIC #### Training data characteristics
...
# MAGIC %md
# MAGIC #### Metric for the original datasets (without any classifiers)
...
# MAGIC %md
# MAGIC ### Train classifier (logistic regression on original training data)
...
# MAGIC %md
# MAGIC #### Results before post-processing
...
# MAGIC %md
# MAGIC ### Perform odds equalizing post processing on scores
...
# MAGIC %md
# MAGIC ### Transform validation and test data using the post processing algorithm
...
# MAGIC %md
# MAGIC #### Results after post-processing
